...
let in_0_skg = document.getElementById('id_form-0-content_of_the_component');
let in_0_dkg = document.getElementById('id_form-0-proportion_of_the_component');
...
let in_1_skg = document.getElementById('id_form-1-content_of_the_component');
let in_1_dkg = document.getElementById('id_form-1-proportion_of_the_component');
...
let in_2_skg = document.getElementById('id_form-2-content_of_the_component');
let in_2_dkg = document.getElementById('id_form-2-proportion_of_the_component');
...
let in_3_skg = document.getElementById('id_form-3-content_of_the_component');
let in_3_dkg = document.getElementById('id_form-3-proportion_of_the_component');
...
let in_4_skg = document.getElementById('id_form-4-content_of_the_component');
let in_4_dkg = document.getElementById('id_form-4-proportion_of_the_component');
...
let in_5_skg = document.getElementById('id_form-5-content_of_the_component');
let in_5_dkg = document.getElementById('id_form-5-proportion_of_the_component');
...
let in_6_skg = document.getElementById('id_form-6-content_of_the_component');
let in_6_dkg = document.getElementById('id_form-6-proportion_of_the_component');
...
let in_7_skg = document.getElementById('id_form-7-content_of_the_component');
let in_7_dkg = document.getElementById('id_form-7-proportion_of_the_component');
...
let in_8_skg = document.getElementById('id_form-8-content_of_the_component');
let in_8_dkg = document.getElementById('id_form-8-proportion_of_the_component');
...
let in_9_skg = document.getElementById('id_form-9-content_of_the_component');
let in_9_dkg = document.getElementById('id_form-9-proportion_of_the_component');
...
let in_10_skg = document.getElementById('id_form-10-content_of_the_component');
let in_10_dkg = document.getElementById('id_form-10-proportion_of_the_component');
...
let in_11_skg = document.getElementById('id_form-11-content_of_the_component');
let in_11_dkg = document.getElementById('id_form-11-proportion_of_the_component');

in_0_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_1_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_2_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_3_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_4_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_5_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_6_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_7_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_8_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_9_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_10_msk.addEventListener('input', function (){summa_msk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})

in_0_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_1_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_2_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_3_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_4_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_5_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_6_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_7_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_8_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_9_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
in_10_mmk.addEventListener('input', function (){summa_mmk();summa_mmo();calculated_mr(summa_mmo());calculated_skg(calculated_mr(summa_mmo()));calculated_dkg(calculated_skg(calculated_mr(summa_mmo())));})
...
function calculated_dkg(array_skg){
    in_0_dkg.value = Number(array_skg[0]) / Number(in_0_mmk.value) * 24.04;
    in_1_dkg.value = Number(array_skg[1]) / Number(in_1_mmk.value) * 24.04;
    in_2_dkg.value = Number(array_skg[2]) / Number(in_2_mmk.value) * 24.04;
    in_3_dkg.value = Number(array_skg[3]) / Number(in_3_mmk.value) * 24.04;
    in_4_dkg.value = Number(array_skg[4]) / Number(in_4_mmk.value) * 24.04;
    in_5_dkg.value = Number(array_skg[5]) / Number(in_5_mmk.value) * 24.04;
    in_6_dkg.value = Number(array_skg[6]) / Number(in_6_mmk.value) * 24.04;
    in_7_dkg.value = Number(array_skg[7]) / Number(in_7_mmk.value) * 24.04;
    in_8_dkg.value = Number(array_skg[8]) / Number(in_8_mmk.value) * 24.04;
    in_9_dkg.value = Number(array_skg[9]) / Number(in_9_mmk.value) * 24.04;
    in_10_dkg.value = Number(array_skg[10]) / Number(in_10_mmk.value) * 24.04;
    in_11_dkg.value = Number(in_0_dkg.value) + Number(in_1_dkg.value) + Number(in_2_dkg.value) + Number(in_3_dkg.value) + Number(in_4_dkg.value) + Number(in_5_dkg.value) + Number(in_6_dkg.value) + Number(in_7_dkg.value) + Number(in_8_dkg.value) + Number(in_9_dkg.value) + Number(in_10_dkg.value);
}


function calculated_skg(array_mr){
    in_0_skg.value = 1.1500 * Number(array_mr[0]) / 100;
    in_1_skg.value = 1.1500 * Number(array_mr[1]) / 100;
    in_2_skg.value = 1.1500 * Number(array_mr[2]) / 100;
    in_3_skg.value = 1.1500 * Number(array_mr[3]) / 100;
    in_4_skg.value = 1.1500 * Number(array_mr[4]) / 100;
    in_5_skg.value = 1.1500 * Number(array_mr[5]) / 100;
    in_6_skg.value = 1.1500 * Number(array_mr[6]) / 100;
    in_7_skg.value = 1.1500 * Number(array_mr[7]) / 100;
    in_8_skg.value = 1.1500 * Number(array_mr[8]) / 100;
    in_9_skg.value = 1.1500 * Number(array_mr[9]) / 100;
    in_10_skg.value = 1.1500 * Number(array_mr[10]) / 100;
    in_11_skg.value = Number(in_0_skg.value) + Number(in_1_skg.value) + Number(in_2_skg.value) + Number(in_3_skg.value) + Number(in_4_skg.value) + Number(in_5_skg.value) + Number(in_6_skg.value) + Number(in_7_skg.value) + Number(in_8_skg.value) + Number(in_9_skg.value) + Number(in_10_skg.value);
    return [in_0_skg.value, in_1_skg.value, in_2_skg.value, in_3_skg.value, in_4_skg.value,
        in_5_skg.value, in_6_skg.value, in_7_skg.value, in_8_skg.value, in_9_skg.value, in_10_skg.value]
...
function calculated_mr(summa_mmo){
    ...
    return [in_0_mr.value, in_1_mr.value, in_2_mr.value, in_3_mr.value, in_4_mr.value,
        in_5_mr.value, in_6_mr.value, in_7_mr.value, in_8_mr.value, in_9_mr.value, in_10_mr.value]
}
